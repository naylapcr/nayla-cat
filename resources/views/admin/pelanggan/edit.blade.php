                    ...
                    <form action="{{ route('pelanggan.update', $dataPelanggan->pelanggan_id) }}" method="POST">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-lg-4 col-sm-12">
                                ...
                                <div class="mb-3">
                                    <label for="photos" class="form-label fw-bold">Tambah File Baru</label>
                                    <input type="file" class="form-control" name="files" multiple >
                                    <small class="text-muted">Bisa pilih banyak sekaligus. Foto lama tidak akan hilang
                                        kecuali dihapus di bawah.</small>
                                </div>

                                <!-- Buttons -->
                                <div class="">
                                    <button type="submit" href="{{ route('pelanggan.index') }}" class="btn btn-primary">Simpan</button>
